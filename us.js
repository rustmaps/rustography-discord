 ...
 */
 ...
 async function fetchServerData() {
   return await fetch('https://www.battlemetrics.com/servers/rust/2507013')
    .then(res => res.text())
    .then(text => {
       try {
...
client.login('NDc3Mzk0NjU1MzQwNzg5NzYw.Dk7gMw.5DMExRVjpnAkqoYuelatgpvGpa4');
